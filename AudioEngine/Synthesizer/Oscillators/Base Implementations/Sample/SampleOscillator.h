...
private:
    ...
    float repeat_low_idx;
    float repeat_high_idx;
    bool repeat_enabled;
...
public:
    ...
    void set_sample(const std::vector<float>* sample, float raw_sample_rate, float target_sample_rate, float base_frequency, float repeat_low, float repeat_high);
